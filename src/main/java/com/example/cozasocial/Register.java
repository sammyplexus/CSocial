    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((username1.getText().toString().equals("") || email_add1.getText().toString().equals("")) || password1.getText().toString().equals(""))
                {

                    Toast.makeText(Register.this, "Oops! Something missing there. Enter all details and try again", Toast.LENGTH_LONG).show();
                }
                else
                {
